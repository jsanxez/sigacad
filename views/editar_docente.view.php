            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="../views/editar_docente.view.php" method="post"
                            ...
                            <div class="item form-group">
                                ...
                                if (isset($_POST["eliminar_select"])) {
                                    ...
                                    if (isset($_POST["select"])){
                                        ...
                                        $dni = $_POST["select"];
                                        //eliminar datos de docentes_cursos y docentes:
                                        $afectados_dc = Docente::delete_from_by("docentes_cursos",$dni);
                                        $afectados = Docente::delete_by_dni($dni);
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Titulo profesional <span
                                            class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="name" name="direccion" class="form-control col-md-7 col-xs-12"
                                           value="<?php if ($filas == 1) echo $direccion; ?>">
                                </div>
                            </div>
